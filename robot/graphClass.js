...
class Graph
{
    ...
    focus()
    {
        ...
        let pointRange = (outerDia - innerDia);
        let units2 = 1;
        let unitsMultiplier2 = 1;

        while((units2 * 12) < pointRange)
        {
        ...
        //this.cSoX = 3 * 77 - ((outerDia + innerDia) / 2) * 7;
        this.cSoX = (((outerDia + innerDia) / 2) * ((77 + this.zoom * 7) / this.graphUnit));
        this.cSoXprev = this.cSoX;
        this.graphUnit = units2;

        this.drawCS();
        console.log(outerDia);
